...
/* harmony import */ var _user_category_detail_category_detail_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./user/category-detail/category-detail.component */ "./src/app/user/category-detail/category-detail.component.ts");
/* harmony import */ var _user_favorite_favorite_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./user/favorite/favorite.component */ "./src/app/user/favorite/favorite.component.ts");
/* harmony import */ var _helper_auth_guard__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./helper/auth-guard */ "./src/app/helper/auth-guard.ts");
/* harmony import */ var _auth_login1_login1_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./auth/login1/login1.component */ "./src/app/auth/login1/login1.component.ts");
/* harmony import */ var _auth_register1_register1_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./auth/register1/register1.component */ "./src/app/auth/register1/register1.component.ts");
/* harmony import */ var _auth_resetpass_resetpass_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./auth/resetpass/resetpass.component */ "./src/app/auth/resetpass/resetpass.component.ts");
...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'document',
                loadChildren: () => Promise.all(/*! import() | administrator-product-product-module */[__webpack_require__.e("common"), __webpack_require__.e("administrator-product-product-module")]).then(__webpack_require__.bind(null, /*! ./administrator/product/product.module */ "./src/app/administrator/product/product.module.ts")).then(module => module.ProductModule)
            },
            {
                path: 'category',
                loadChildren: () => Promise.all(/*! import() | administrator-category-category-module */[__webpack_require__.e("common"), __webpack_require__.e("administrator-category-category-module")]).then(__webpack_require__.bind(null, /*! ./administrator/category/category.module */ "./src/app/administrator/category/category.module.ts")).then(module => module.CategoryModule)
            },
            {
                path: 'topic',
                loadChildren: () => __webpack_require__.e(/*! import() | administrator-topic-topic-module */ "administrator-topic-topic-module").then(__webpack_require__.bind(null, /*! ./administrator/topic/topic.module */ "./src/app/administrator/topic/topic.module.ts")).then(module => module.TopicModule)
            },
            {
                path: 'reader',
                loadChildren: () => Promise.all(/*! import() | administrator-reader-reader-module */[__webpack_require__.e("common"), __webpack_require__.e("administrator-reader-reader-module")]).then(__webpack_require__.bind(null, /*! ./administrator/reader/reader.module */ "./src/app/administrator/reader/reader.module.ts")).then(module => module.ReaderModule)
            },
            {
                path: 'publishing-company',
                // tslint:disable-next-line:max-line-length
                loadChildren: () => Promise.all(/*! import() | administrator-publishing-company-publishing-company-module */[__webpack_require__.e("common"), __webpack_require__.e("administrator-publishing-company-publishing-company-module")]).then(__webpack_require__.bind(null, /*! ./administrator/publishing-company/publishing-company.module */ "./src/app/administrator/publishing-company/publishing-company.module.ts")).then(module => module.PublishingCompanyModule)
            }, {
                path: 'author',
                loadChildren: () => Promise.all(/*! import() | administrator-author-author-module */[__webpack_require__.e("common"), __webpack_require__.e("administrator-author-author-module")]).then(__webpack_require__.bind(null, /*! ./administrator/author/author.module */ "./src/app/administrator/author/author.module.ts")).then(module => module.AuthorModule)
            }, {
                path: 'chart',
                loadChildren: () => __webpack_require__.e(/*! import() | administrator-chart-chart-module */ "administrator-chart-chart-module").then(__webpack_require__.bind(null, /*! ./administrator/chart/chart.module */ "./src/app/administrator/chart/chart.module.ts")).then(module => module.ChartModule)
            }
        ],
    },
    {
...
/* harmony import */ var _user_homepage_homepage_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./user/homepage/homepage.component */ "./src/app/user/homepage/homepage.component.ts");
/* harmony import */ var _user_shop_shop_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./user/shop/shop.component */ "./src/app/user/shop/shop.component.ts");
/* harmony import */ var _shared_header_header_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./shared/header/header.component */ "./src/app/shared/header/header.component.ts");
/* harmony import */ var _shared_footer_footer_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./shared/footer/footer.component */ "./src/app/shared/footer/footer.component.ts");
/* harmony import */ var _user_contact_contact_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./user/contact/contact.component */ "./src/app/user/contact/contact.component.ts");
/* harmony import */ var _user_product_detail_product_detail_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./user/product-detail/product-detail.component */ "./src/app/user/product-detail/product-detail.component.ts");
/* harmony import */ var _user_category_detail_category_detail_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./user/category-detail/category-detail.component */ "./src/app/user/category-detail/category-detail.component.ts");
/* harmony import */ var _user_favorite_favorite_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./user/favorite/favorite.component */ "./src/app/user/favorite/favorite.component.ts");
...
/* harmony import */ var _layout_layout_host_layout_host_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./layout/layout-host/layout-host.component */ "./src/app/layout/layout-host/layout-host.component.ts");
/* harmony import */ var _auth_login1_login1_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./auth/login1/login1.component */ "./src/app/auth/login1/login1.component.ts");
/* harmony import */ var _auth_register1_register1_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./auth/register1/register1.component */ "./src/app/auth/register1/register1.component.ts");
/* harmony import */ var ng_image_slider__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ng-image-slider */ "./node_modules/ng-image-slider/fesm2015/ng-image-slider.js");
...
/* harmony import */ var _shared_header_user_item_user_item_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./shared/header/user-item/user-item.component */ "./src/app/shared/header/user-item/user-item.component.ts");
...
/* harmony import */ var angularx_social_login__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! angularx-social-login */ "./node_modules/angularx-social-login/fesm2015/angularx-social-login.js");
/* harmony import */ var _auth_resetpass_resetpass_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./auth/resetpass/resetpass.component */ "./src/app/auth/resetpass/resetpass.component.ts");
/* harmony import */ var _shared_header_chagepassword_chagepassword_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./shared/header/chagepassword/chagepassword.component */ "./src/app/shared/header/chagepassword/chagepassword.component.ts");
/* harmony import */ var _user_homepage_quickview_quickview_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./user/homepage/quickview/quickview.component */ "./src/app/user/homepage/quickview/quickview.component.ts");
/* harmony import */ var ngx_paypal__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ngx-paypal */ "./node_modules/ngx-paypal/fesm2015/ngx-paypal.js");
...
/* harmony import */ var ng2_pdf_viewer__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ng2-pdf-viewer */ "./node_modules/ng2-pdf-viewer/fesm2015/ng2-pdf-viewer.js");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _user_homepage_homepage_component__WEBPACK_IMPORTED_MODULE_16__["HomepageComponent"],
            _user_shop_shop_component__WEBPACK_IMPORTED_MODULE_17__["ShopComponent"],
            _shared_header_header_component__WEBPACK_IMPORTED_MODULE_18__["HeaderComponent"],
            _shared_footer_footer_component__WEBPACK_IMPORTED_MODULE_19__["FooterComponent"],
            _user_contact_contact_component__WEBPACK_IMPORTED_MODULE_20__["ContactComponent"],
            _user_product_detail_product_detail_component__WEBPACK_IMPORTED_MODULE_21__["ProductDetailComponent"],
            _user_category_detail_category_detail_component__WEBPACK_IMPORTED_MODULE_22__["CategoryDetailComponent"],
            _user_favorite_favorite_component__WEBPACK_IMPORTED_MODULE_23__["FavoriteComponent"],
            _admin_admin_component__WEBPACK_IMPORTED_MODULE_24__["AdminComponent"],
            _layout_layout_host_layout_host_component__WEBPACK_IMPORTED_MODULE_25__["LayoutHostComponent"],
            _auth_login1_login1_component__WEBPACK_IMPORTED_MODULE_26__["Login1Component"],
            _auth_register1_register1_component__WEBPACK_IMPORTED_MODULE_27__["Register1Component"],
            _shared_header_user_item_user_item_component__WEBPACK_IMPORTED_MODULE_30__["UserItemComponent"],
            _auth_resetpass_resetpass_component__WEBPACK_IMPORTED_MODULE_34__["ResetpassComponent"],
            _shared_header_chagepassword_chagepassword_component__WEBPACK_IMPORTED_MODULE_35__["ChagepasswordComponent"],
            _user_homepage_quickview_quickview_component__WEBPACK_IMPORTED_MODULE_36__["QuickviewComponent"]
        ],
        imports: [
            ...
            _angular_fire__WEBPACK_IMPORTED_MODULE_12__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_13__["environment"].firebaseConfig),
            ...
            ngx_paypal__WEBPACK_IMPORTED_MODULE_37__["NgxPayPalModule"],
            ng_image_slider__WEBPACK_IMPORTED_MODULE_28__["NgImageSliderModule"],
            ...
            angularx_social_login__WEBPACK_IMPORTED_MODULE_33__["SocialLoginModule"],
...
let DocumentService = class DocumentService {
    ...
    update(id, document) {
        return this.http.put(API_URL + `/documents/${id}`, document);
    }
    delete(id) {
...
let TopicService = class TopicService {
    ...
    updateTopic(id, Topic) {
        return this.http.put(API_URL + `/topics/${id}`, Topic);
    }
    deleteTopic(id) {
        return this.http.delete(API_URL + `/topics/${id}`);
    }
    deleteListTopic(id) {
...
/* harmony import */ var _user_item_user_item_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./user-item/user-item.component */ "./src/app/shared/header/user-item/user-item.component.ts");
/* harmony import */ var _chagepassword_chagepassword_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./chagepassword/chagepassword.component */ "./src/app/shared/header/chagepassword/chagepassword.component.ts");
...
let HeaderComponent = class HeaderComponent {
    constructor(categoryService, authenticationService, userService, router) {
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_user_item_user_item_component__WEBPACK_IMPORTED_MODULE_6__["UserItemComponent"])
], HeaderComponent.prototype, "view", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_chagepassword_chagepassword_component__WEBPACK_IMPORTED_MODULE_7__["ChagepasswordComponent"])
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _service_auth_authentication_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../service/auth/authentication.service */ "./src/app/service/auth/authentication.service.ts");
/* harmony import */ var _homepage_quickview_quickview_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../homepage/quickview/quickview.component */ "./src/app/user/homepage/quickview/quickview.component.ts");
/* harmony import */ var src_environments_environment__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/environments/environment */ "./src/environments/environment.ts");
/* harmony import */ var src_app_service_document_document_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/service/document/document.service */ "./src/app/service/document/document.service.ts");
...
let CategoryDetailComponent = class CategoryDetailComponent {
    constructor(categoryService, documentService, activatedRoute, authenticationService, router) {
        this.categoryService = categoryService;
        ...
        this.sub = this.activatedRoute.paramMap.subscribe((paramMap) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.listCategory = yield this.getCategory(id);
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_homepage_quickview_quickview_component__WEBPACK_IMPORTED_MODULE_6__["QuickviewComponent"])
...
let FavoriteComponent = class FavoriteComponent {
    constructor(categoryService, activatedRoute, authenticationService, router) {
        this.categoryService = categoryService;
        this.activatedRoute = activatedRoute;
        this.authenticationService = authenticationService;
        this.router = router;
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _service_auth_authentication_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../service/auth/authentication.service */ "./src/app/service/auth/authentication.service.ts");
/* harmony import */ var _quickview_quickview_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./quickview/quickview.component */ "./src/app/user/homepage/quickview/quickview.component.ts");
/* harmony import */ var src_app_service_topic_topic_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/service/topic/topic.service */ "./src/app/service/topic/topic.service.ts");
...
let HomepageComponent = class HomepageComponent {
    constructor(categoryService, authenticationService, topicService, router) {
        this.categoryService = categoryService;
        this.authenticationService = authenticationService;
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_quickview_quickview_component__WEBPACK_IMPORTED_MODULE_6__["QuickviewComponent"])
...
/* harmony import */ var _service_auth_authentication_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../service/auth/authentication.service */ "./src/app/service/auth/authentication.service.ts");
/* harmony import */ var _homepage_quickview_quickview_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../homepage/quickview/quickview.component */ "./src/app/user/homepage/quickview/quickview.component.ts");
/* harmony import */ var src_app_service_document_document_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/service/document/document.service */ "./src/app/service/document/document.service.ts");
...
let ProductDetailComponent = class ProductDetailComponent {
    constructor(categoryService, activatedRoute, documentService, authenticationService, router) {
        this.categoryService = categoryService;
        this.activatedRoute = activatedRoute;
        this.documentService = documentService;
        this.authenticationService = authenticationService;
    ...
    getDocumentByCategory(id) {
        this.documentService.findCategories(id).subscribe((res) => {
            this.listHouseSaleOff = res;
            if (this.listHouseSaleOff.length > 0) {
                this.listHouseSaleOff = this.listHouseSaleOff.filter((x) => x.id !== this.id);
            }
        });
    }
    ngOnInit() {
...
module.exports = __webpack_require__(/*! C:\Users\VU_MINH_PC\Downloads\DoAn_Phone\libraryFE\src\main.ts */"./src/main.ts");
