...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["administrator-chart-chart-module"], {
  ...
  /***/
  function node_modulesChartJsDistChartEsmJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
      ...
      _createClass(Chart, [{
        ...
        value: function _updateDatasets(mode) {
          ...
          for (var _i4 = 0, _ilen = this.data.datasets.length; _i4 < _ilen; ++_i4) {
            this._updateDataset(_i4, Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["a4"])(mode) ? mode({
              datasetIndex: _i4
            }) : mode);
          }
    ...
    var ArcElement = /*#__PURE__*/function (_Element2) {
      ...
      _createClass(ArcElement, [{
        ...
        value: function inRange(chartX, chartY, useFinalPosition) {
          ...
          var withinRadius = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["ag"])(distance, innerRadius + rAdjust, outerRadius + rAdjust);
    ...
    var LineElement = /*#__PURE__*/function (_Element3) {
      ...
      _createClass(LineElement, [{
        ...
        value: function interpolate(point, property) {
          ...
          var points = this.points;
          var segments = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["ak"])(this, {
            property: property,
            start: value,
            end: value
          });
    ...
    function _inRange(bar, x, y, useFinalPosition) {
      ...
      return bounds && (skipX || Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["ag"])(x, bounds.left, bounds.right)) && (skipY || Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["ag"])(y, bounds.top, bounds.bottom));
    }
    ...
    var BarElement = /*#__PURE__*/function (_Element5) {
      ...
      _createClass(BarElement, [{
        ...
        value: function draw(ctx) {
          ...
          var addRectPath = hasRadius(outer.radius) ? _chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["ar"] : addNormalRectPath;
          ctx.save();
    ...
    function _segments(line, target, property) {
      ...
      try {
        for (_iterator16.s(); !(_step16 = _iterator16.n()).done;) {
          ...
          var targetSegments = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["ak"])(target, bounds);
          ...
          try {
            for (_iterator17.s(); !(_step17 = _iterator17.n()).done;) {
              ...
              var fillSources = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["au"])(segment, points, subBounds);
    ...
    var Legend = /*#__PURE__*/function (_Element6) {
      ...
      _createClass(Legend, [{
        ...
        value: function adjustHitBoxes() {
          ...
          var rtlHelper = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aw"])(rtl, this.left, this.width);
        ...
        value: function _draw() {
          ...
          var rtlHelper = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aw"])(opts.rtl, this.left, this.width);
          var labelFont = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["Y"])(labelOpts.font);
          ...
          var drawLegendBox = function drawLegendBox(x, y, legendItem) {
            ...
            if (labelOpts.usePointStyle) {
              ...
              var borderRadius = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["at"])(legendItem.borderRadius);
              ctx.beginPath();
          ...
          this.legendItems.forEach(function (legendItem, i) {
            ...
            x = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["ay"])(textAlign, x + boxWidth + halfFontSize, isHorizontal ? x + width : _this28.right, opts.rtl);
        ...
        value: function _getLegendItemAt(x, y) {
          ...
          if (Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["ag"])(x, this.left, this.right) && Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["ag"])(y, this.top, this.bottom)) {
            lh = this.legendHitBoxes;

            for (i = 0; i < lh.length; ++i) {
              hitBox = lh[i];

              if (Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["ag"])(x, hitBox.left, hitBox.left + hitBox.width) && Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["ag"])(y, hitBox.top, hitBox.top + hitBox.height)) {
      ...
      nearest: function nearest(items, eventPosition) {
        ...
        for (i = 0, len = items.length; i < len; ++i) {
          ...
          if (el && el.hasValue()) {
            ...
            var d = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aB"])(eventPosition, center);
    ...
    function getBackgroundPoint(options, size, alignment, chart) {
      ...
      var _Object4 = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["at"])(cornerRadius),
    ...
    var Tooltip = /*#__PURE__*/function (_Element8) {
      ...
      _createClass(Tooltip, [{
        ...
        value: function getCaretPosition(tooltipPoint, size, options) {
          ...
          var _Object5 = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["at"])(cornerRadius),
        ...
        value: function drawTitle(pt, ctx, options) {
          ...
          if (length) {
            var rtlHelper = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aw"])(options.rtl, this.x, this.width);
        ...
        value: function _drawColorBox(ctx, pt, i, rtlHelper, options) {
          ...
          if (options.usePointStyle) {
            ...
            var borderRadius = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["at"])(labelColors.borderRadius);
        ...
        value: function drawBackground(pt, ctx, tooltipSize, options) {
          ...
          var _Object6 = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["at"])(options.cornerRadius),
    ...
    function generateTicks$1(generationOptions, dataRange) {
      ...
      var spacing = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aD"])((rmax - rmin) / maxSpaces / unit) * unit;
      ...
      var decimalPlaces = Math.max(Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aG"])(spacing), Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aG"])(niceMin));
    ...
    function addTick(ticks, time, timestamps) {
      if (!timestamps) {
        ...
        var _Object7 = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aJ"])(timestamps, time),
            lo = _Object7.lo,
            hi = _Object7.hi;
    ...
    var TimeScale = /*#__PURE__*/function (_Scale4) {
      ...
      _createClass(TimeScale, [{
        ...
        value: function buildTicks() {
          ...
          var min = this.min;
          var max = this.max;
          var ticks = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aI"])(timestamps, min, max);
  ...
  /***/
  function node_modulesChartJsDistChunksHelpersSegmentJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "a_", function () {
      return _angleDiff;
    });
    /* harmony export (binding) */
    ...
    function addScopes(set, parentScopes, key, parentFallback) {
      var _iterator26 = _createForOfIteratorHelper(parentScopes),
          _step26;

      try {
        for (_iterator26.s(); !(_step26 = _iterator26.n()).done;) {
          var parent = _step26.value;
    ...
    function _resolveWithPrefixes(prop, prefixes, scopes, proxy) {
      ...
      var _iterator27 = _createForOfIteratorHelper(prefixes),
          _step27;

      try {
        for (_iterator27.s(); !(_step27 = _iterator27.n()).done;) {
          var prefix = _step27.value;
    ...
    function _resolve(key, scopes) {
      var _iterator28 = _createForOfIteratorHelper(scopes),
          _step28;

      try {
        for (_iterator28.s(); !(_step28 = _iterator28.n()).done;) {
          var scope = _step28.value;
    ...
    function resolveKeysFromAllScopes(scopes) {
      ...
      var _iterator29 = _createForOfIteratorHelper(scopes),
          _step29;

      try {
        for (_iterator29.s(); !(_step29 = _iterator29.n()).done;) {
          var scope = _step29.value;

          var _iterator30 = _createForOfIteratorHelper(Object.keys(scope).filter(function (k) {
    ...
    function normalizeSegment(_ref11) {
    ...
    function doSplitByStyles(line, segments, points, segmentOptions) {
      ...
      var _iterator31 = _createForOfIteratorHelper(segments),
          _step31;

      try {
        for (_iterator31.s(); !(_step31 = _iterator31.n()).done;) {
          var segment = _step31.value;
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppAdministratorChartChartChartComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAdministratorChartChartRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var ChartRoutingModule = function ChartRoutingModule() {
      _classCallCheck(this, ChartRoutingModule);
    };

    ChartRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppAdministratorChartChartModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _chart_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    ChartModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_chart_chart_component__WEBPACK_IMPORTED_MODULE_4__["ChartComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _chart_routing_module__WEBPACK_IMPORTED_MODULE_3__["ChartRoutingModule"], ng2_pdf_viewer__WEBPACK_IMPORTED_MODULE_5__["PdfViewerModule"]]
    })], ChartModule);
    /***/
  },
  ...
  /***/
  function srcAppAdministratorChartChartChartComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAdministratorChartChartChartComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_service_document_document_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    var ChartComponent = /*#__PURE__*/function () {
      function ChartComponent(documentService) {
      ...
      _createClass(ChartComponent, [{
        ...
        value: function getDocument() {
          ...
          this.documentService.getAll().subscribe(function (res) {
            ...
            _this43.listDocument = res.slice(0, 5);
        ...
        value: function initChart() {
          ...
          var listLabel = this.listDocument.map(function (item) {
            return item.name;
          });
          var listData = this.listDocument.map(function (item) {
            return item.visitNumber;
          });
          var myChart = new chart_js__WEBPACK_IMPORTED_MODULE_2__["Chart"](ctx, {
            type: 'bar',
            data: {
              labels: listLabel,
              datasets: [{
    ...
    ChartComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/administrator/chart/chart/chart.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./chart.component.scss */
      "./src/app/administrator/chart/chart/chart.component.scss"))["default"]]
    })], ChartComponent);
    /***/
  }
}]);
//# sourceMappingURL=administrator-chart-chart-module-es5.js.map